      ...
      <div className="search__cards my-5 w-[73%] space-y-14">
        {videos.map((video) => (
          <Link to={`/watch/${video.videoId}`}>
            <div className="card h-[10rem] my-14" key={video.videoId}>
              <div className="thumbnail__title flex">
                ...
                />
                <h3 className="text-lg px-3">{trim(video.title)}</h3>
              </div>
              <div className="relative bottom-44 left-[22.5rem] px-4">
                ...
                <div className="channel__details flex text-[13px] text-[#606060] my-2 mt-3">
                  ...
                  />
                  <div className="time text-[12px] text-white absolute -left-10 top-[155px] z-10 px-1 font-bold rounded-md bg-black">
                    {video.lengthText}
                  </div>

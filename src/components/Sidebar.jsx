...
function Sidebar() {
  return (
    <div className="sidebar fixed top-10 left-0 py-8 w-[15vw] h-[100vh] overflow-y-scroll hidden lg:block">
      <div className="container">
        <div className="one space-y-2 flex flex-col">
          ...
          <button className="focus:bg-[#d9d9d9] pl-8 pr-14 py-2 focus:font-bold hover:bg-gray-100 text-left text-md flex items-center">
            <img
              src="https://cdn-icons-png.flaticon.com/512/795/795653.png"
              alt=""
              className="w-[20px] h-[20px] mr-2"
            />{" "}
            Explore
          ...
          <button className="focus:bg-[#d9d9d9] pl-8 pr-14 py-2 focus:font-bold hover:bg-gray-100 text-left text-md flex items-center">
            <img
              src="https://cdn-icons-png.flaticon.com/512/8669/8669536.png"
              alt=""
              className="w-[20px] h-[20px] mr-2"
            />{" "}
            Subscriptions
        ...
        <div className="three space-y-2 flex flex-col">
          <h1 className="pl-4 pr-14 py-2 text-[1rem] text-left font-semibond text-gray-600">
            EXPLORE
          </h1>
          <button className="focus:bg-[#d9d9d9] pl-8 pr-14 py-2 focus:font-bold hover:bg-gray-100 text-left text-md flex items-center">
            <img
              src="https://cdn-icons-png.flaticon.com/512/5649/5649349.png"
              alt=""
              className="w-[20px] h-[20px] mr-2"
            />{" "}
            Music
